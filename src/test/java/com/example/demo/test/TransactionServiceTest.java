...
import com.example.demo.model.UPITransaction; // Import UPITransaction model class
import com.example.demo.model.BankTransferTransaction; // Import BankTransferTransaction model class
import com.example.demo.model.Transaction; // Import Transaction base class
import com.example.demo.repository.TransactionRepository; // Import TransactionRepository interface
import com.example.demo.service.TransactionService; // Import TransactionService class
...
public class TransactionServiceTest {
    ...
    @Mock
    private TransactionRepository transactionRepository; // Mocked TransactionRepository
