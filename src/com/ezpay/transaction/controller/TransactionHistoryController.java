...
public class TransactionHistoryController {
    ...
    public static void main(String[] args) {
        ...
        UPITransaction sampleUpi_trans1 = new UPITransaction(5, "UPI", 100.0,
                LocalDate.now().minusYears(2), "Success", "UPI1", "user1");
        UPITransaction sampleUpi_trans2 = new UPITransaction(6, "UPI", 10.0,
                LocalDate.now().minusMonths(4), "Success", "UPI2", "user1");
        UPITransaction sampleUpi_trans3 = new UPITransaction(7, "UPI", 1000.0,
                LocalDate.now().minusYears(1), "Failure", "UPI3", "user1");
        UPITransaction sampleUpi_trans4 = new UPITransaction(8, "UPI", 100000.0,
                LocalDate.now().minusWeeks(4), "Processing", "UPI4", "user1");

        BankTransferTransaction sampleBankTransfer1 = new BankTransferTransaction(9, "Bank Transfer", 2000.0,
                LocalDate.now().minusYears(5), "Success", "Bank Transfer1", "user1", "user2");

        BankTransferTransaction sampleBankTransfer2 = new BankTransferTransaction(10, "Bank Transfer", 15000.0,
                LocalDate.now().minusYears(6), "Failure", "Bank Transfer2", "user1", "user2");

        BankTransferTransaction sampleBankTransfer3 = new BankTransferTransaction(11, "Bank Transfer", 20230.0,
