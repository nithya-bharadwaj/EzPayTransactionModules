export async function getTransactionHistory() {
	const response = await fetch("http://localhost:8090/transactions/history");
	if (response.ok) {
...
export async function getTransactionById(id) {
	const response = await fetch(`http://localhost:8090/transactions/${id}`);
	if (response.ok) {
		return response.json();
	} else {
...
export async function filterTransactionsByType(type) {
	const response = await fetch(`http://localhost:8090/transactions/filterByType?type=${type}`);
	if (response.ok) {
		return response.json();
	} else {
...
export async function filterTransactionsByStatus(status) {
	const response = await fetch(`http://localhost:8090/transactions/filterByStatus?status=${status}`);
	if (response.ok) {
		return response.json();
	} else {
...
export async function filterTransactionsByDateRange(startDate, endDate) {
	const response = await fetch(`http://localhost:8090/transactions/filterByDateRange?startDate=${startDate}&endDate=${endDate}`);
	if (response.ok) {
		return response.json();
	} else {
